...
const prodDependencies = (config) => {
  ...
  if (config.framework && config.framework !== 'koa') prodDependencies.push('morgan');
  ...
  if (config.framework && config.framework === 'koa') {
    prodDependencies.push('koa-morgan');
...
const devDependencies = (config) => {
  ...
  if (config.language === 'typescript') {
    ...
    if (config.framework && config.framework !== 'koa') devDependencies.push('@types/morgan');
    if (config.framework && config.framework === 'koa') {
      devDependencies.push('@types/koa', '@types/koa-morgan');
